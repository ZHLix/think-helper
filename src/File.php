 ...
 * @LastEditTime: 2020-12-09 09:31:35
 * @FilePath: /app/vendor/zhlix/think-helper/src/File.php
 */
...
class File
{
    ...
    {
        return str_replace('//', '_%_', aes_encode(str_replace("{$this->config['upload_base_dir']}/", '', $path)));
    }
